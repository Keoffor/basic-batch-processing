...
import com.kenstudy.batch_processing.repository.CustomerRepository;
...
public class SpringBatchConfig {
    ...
    @Bean
    public Step step1(JobRepository repository, PlatformTransactionManager transactionManager){
    ...
    public Job runJob(JobRepository jobRepository,Step step1 ){
        return new JobBuilder("importStep",jobRepository )
                .start(step1)
                .build();
    }
}
